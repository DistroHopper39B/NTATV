...
* When using the Brazilian Portuguese version of Windows XP, FreeLoader fails to read the registry when the NVIDIA driver is installed. See [#9](https://github.com/DistroHopper39B/NTATV/issues/9)
