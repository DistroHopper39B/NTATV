...
* With the NVIDIA driver installed, if the display goes into standby, unplugging and re-plugging the HDMI is required to get a picture. Disable standby in the Power Options control panel to avoid this issue.
